...
public class EmotionSad extends AmuletText {
    ...
    private static final String AURA_DESCRIPTION = "<b>Aura</b>: Allies have -1/-1/+0 and +1 <b>Armor</b>.";
    ...
    public static final TooltipAmulet TOOLTIP = new TooltipAmulet(NAME, DESCRIPTION, "card/indie/emotionsad.png",
    ...
    protected List<Effect> getSpecialEffects() {
        return List.of(
                new EffectAura(AURA_DESCRIPTION, 1, true, false, true, false,
                        new Effect("-1/-1/+0 and +1 <b>Armor</b> (from <b>" + NAME + "</b>).", EffectStats.builder()
                    ...
                    public double getPresenceValue(int refs) {
                        return (AI.valueForBuff(-1, -1, 0) + AI.VALUE_PER_ARMOR) * 3 - 1; // idk
                    }
                },
