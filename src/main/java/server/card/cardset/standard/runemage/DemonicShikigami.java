...
public class DemonicShikigami extends MinionText {
    public static final String NAME = "Demonic Shikigami";
    ...
    public static final TooltipMinion TOOLTIP = new TooltipMinion(NAME, DESCRIPTION, () -> new Animation("card/standard/demonicshikigami.png"),
            CRAFT, TRAITS, RARITY, 3, 3, 2, 4, true, DemonicShikigami.class,
            new Vector2f(138, 146), 1.3, new EventAnimationDamageSlash(),
