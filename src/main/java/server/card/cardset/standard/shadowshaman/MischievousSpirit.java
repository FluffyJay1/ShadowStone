...
import server.ai.AI;
import server.card.*;
import server.card.cardset.basic.shadowshaman.Ghost;
...
public class MischievousSpirit extends MinionText {
    ...
    public static final TooltipMinion TOOLTIP = new TooltipMinion(NAME, DESCRIPTION, "res/card/standard/mischievousspirit.png",
