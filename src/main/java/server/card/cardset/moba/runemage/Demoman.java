...
public class Demoman extends MinionText {
    ...
    private static final String UNLEASH_DESCRIPTION = "<b>Unleash</b>: Summon a <b>Sticky Trap</b> and give it +0/+0/+M.";
    ...
    public static final TooltipMinion TOOLTIP = new TooltipMinion(NAME, DESCRIPTION, () -> new Animation("card/moba/demoman.png"),
            CRAFT, TRAITS, RARITY, 4, 3, 1, 4, false, Demoman.class,
            new Vector2f(), -1, new EventAnimationDamageSmallExplosion(),
            () -> List.of(Tooltip.CLEAVE, Tooltip.BATTLECRY, Tooltip.SPELLBOOST, Tooltip.UNLEASH, StickyTrap.TOOLTIP),
            List.of());
