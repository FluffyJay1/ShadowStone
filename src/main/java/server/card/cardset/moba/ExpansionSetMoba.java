...
import server.card.cardset.moba.dragondruid.WidowMine;
...
public class ExpansionSetMoba extends ExpansionSet {
    ...
    public static final CardSet PLAYABLE_SET = new CardSet(new SiegeTank(), new Tiny(), new Immortal(), new LochnLoad(), new Baneling(),
            ...
            new Heavy(), new Demoman(), new Pyro(), new Soldier(), new Spy(), new Medic(), new Engineer(), new Aghanim(), new BountyHunter(), new WidowMine());
    @Override
