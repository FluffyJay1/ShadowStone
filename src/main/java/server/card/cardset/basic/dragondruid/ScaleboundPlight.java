...
public class ScaleboundPlight extends SpellText {
    ...
    public static final TooltipSpell TOOLTIP = new TooltipSpell(NAME, DESCRIPTION, () -> new Animation("card/basic/scaleboundplight.png"),
            CRAFT, TRAITS, RARITY, 0, ScaleboundPlight.class,
