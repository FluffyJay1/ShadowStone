...
public class Defile extends SpellText {
    ...
    public static final TooltipSpell TOOLTIP = new TooltipSpell(NAME, DESCRIPTION, () -> new Animation("card/basic/defile.png"),
                ...
                return new ResolverWithDescription(DESCRIPTION, new Resolver(false) {
                    ...
                    public void onResolve(ServerBoard b, ResolverQueue rq, List<Event> el) {
                        for (int i = 0; i < 14; i++) {
                            ...
                            DamageResolver damageResolver = new DamageResolver(effect, relevant, 1, true, new EventAnimationDamageAOECloud());
