...
public class RectangleEdgePositionEmissionPropertyStrategy implements EmissionPropertyStrategy {
    Vector2f dim;
    double threshold;

    public RectangleEdgePositionEmissionPropertyStrategy(Vector2f dim) {
        this.dim = dim;
